...
public class Formation extends JFrame {
    ...
    t1.addActionListener(new ActionListener(){
	   public void  actionPerformed(ActionEvent arg0){
	    	try{
				...
				Connect("INSERT INTO stage(cin,type_stage,nom_formation) VALUES ('"+s3.getText()+"','stage intitiation','formation html5/css')");	
    ...
    public void  actionPerformed(ActionEvent arg0){
    	try{
			...
			Connect("INSERT INTO stage(cin,type_stage,nom_formation) VALUES ('"+s3.getText()+"','stage intitiation','formation en algorithme')");	
    ...
    t3.addActionListener(new ActionListener(){
        public void  actionPerformed(ActionEvent arg0){
        	try{
    			...
    			Connect("INSERT INTO stage(cin,type_stage,nom_formation) VALUES ('"+s3.getText()+"','stage intitiation','formation en c')");	
