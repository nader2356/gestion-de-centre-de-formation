...
public class Connection_St  extends JFrame {
	...
	JTextField t1,t3,t4,t5t,t6,t7,t8; 
	JPasswordField t2;
    ...
    esp=new JLabel("   Espace Stagiere");
    ...
    ret.addActionListener(new ActionListener(){
	    public void  actionPerformed(ActionEvent arg0){
	    	Aceuille ac  =new Aceuille("stage");
	    	Aceuille.main(null);
	    }
    });
	    ...
	    public void  actionPerformed(ActionEvent arg0){
	    	{ if ((t1.getText()).equals("") ||(t2.getText()).equals(""))
            {
				...
				int x = Integer.parseInt(t1.getText());
				 ...
				 Stagiere e1 =new Stagiere(x,t2.getText()); 
                 if (e1.exist_stagiere()==true)
                 { t1.setText("");t2.setText("");
                 Stage e2 =new Stage (t1.getText());
	...
	public static void main(String[] args) {
		Connection_St e=new Connection_St("Espace Etudiant");
		}
