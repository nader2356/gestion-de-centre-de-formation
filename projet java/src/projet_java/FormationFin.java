...
public class FormationFin extends JFrame{
    ...
    init=new JLabel("formation en androwide:");
    ...
    t1.setBounds(430, 265, 100, 40);
    t1.addActionListener(new ActionListener(){
 	   public void  actionPerformed(ActionEvent arg0){
 	    	try{
 				
 				Connect("INSERT INTO stage(cin,type_stage,nom_formation) VALUES ('"+s3.getText()+"','stage de fin etude','formation en androwide')");	
    ...
    per=new JLabel("formation en Synfony3:");
    ...
    t2.setBounds(430, 330, 100, 40);
    t2.addActionListener(new ActionListener(){
  	   public void  actionPerformed(ActionEvent arg0){
  	    	try{
  				
  				Connect("INSERT INTO stage(cin,type_stage,nom_formation) VALUES ('"+s3.getText()+"','stage de fin etude','formation en synfonie 3')");	
    ...
    t3.setBounds(430, 390, 100, 40);
    t3.setBackground(new Color(189, 51, 164));
    t3.addActionListener(new ActionListener(){
  	   public void  actionPerformed(ActionEvent arg0){
  	    	try{
  				
  				Connect("INSERT INTO stage(cin,type_stage,nom_formation) VALUES ('"+s3.getText()+"','stage de fin etude','formation en c#')");	
	...
	public static void main (String []args){
		FormationFin fen=new FormationFin("formation stage de fin d'etude");
		fen.setVisible(true);
